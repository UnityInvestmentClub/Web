...
export const SSGPage = () => {
  ...
  const [ssgError, setSSGError] = useState(initialError);
  ...
  const handleSubmit = async() => {
    try {
      ...
      setFormError('Something went wrong! Check you entered everything correctly');
    }
  };
  ...
  return isLoading
    ...
    : (<div className='ssg'>
      ...
      <div className='ssg-buttons'>
        ...
        {formError && <p className='ssg-error'>{formError}</p>}
      </div>
    </div>);
};